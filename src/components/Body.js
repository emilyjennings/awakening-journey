    ...
    <div className="Body">
      <div className="home-message">
        <div className="landing-message">
          ...
          <p class="new">This website is the old version and will be retired soon - <a href="https://www.shaktimindfulawakening.com">check me out at the new site here!</a></p>
